...
gantt
    ...
    %% Definição de Cores por Matéria
    %% STAT: Azul (Fundamentos)
    %% FCST: Púrpura (Previsão)
    %% LOG: Laranja (Estoque)
    %% ANA: Verde (Análise)
    %% OPT: Vermelho (Otimização)
    
    section Fev/Mar - Fundamentos
    Média e Dispersão (STAT)           :done,    stat1, 2026-02-25, 1d
    Médias Móveis (FCST)               :         fcst1, after stat1, 1d
    
    Normal e Probabilidade (STAT)      :active,  stat2, 2026-02-25, 9d
    EDA e Outliers (ANA)               :         ana1, after stat2, 1d
    
    section Mar - Ciclos e Sazonalidade
    Padrão Dente de Serra (LOG)        :         log1, 2026-03-04, 1d
    Séries Temporais (ANA)             :         ana2, 2026-03-18, 1d
    Curva ABC (LOG/ANA)                :crit,    log2, 2026-03-18, 15d
    
    section Abr/Mai - Gestão de Estoque
    Ponto de Reposição (LOG)           :         log3, 2026-04-01, 1d
    Estoque de Segurança (LOG)         :         log4, 2026-05-06, 1d
    Curva de Suprimento (LOG)          :         log5, 2026-05-07, 1d
    Lote Econômico EOQ (LOG)           :         log6, 2026-05-13, 1d
    
    section Mai - Previsão Avançada
    Suavização Exponencial (FCST)      :         fcst2, 2026-05-14, 8d
    Métricas de Erro e Viés (FCST)     :         fcst3, 2026-05-22, 1d
    
    section Jun - Otimização e Projetos
    Grafos e Redes (OPT)               :active,  opt1, 2026-05-28, 1d
    Dijkstra e VRP (OPT)               :         opt2, 2026-05-29, 4d
    Projeto Integrado (Workshop)       :crit,    proj1, 2026-06-03, 20d
    
    section Jul/Ago - Finalização
    Revisão Geral                      :         rev1, 2026-07-14, 1d
    Reserva Técnica                    :         res1, 2026-08-04, 1d
```
...
| Data | Horário | Matéria | Tópico (Conceito $\rightarrow$ Aplicação) | Tipo |
| :--- | :------ | :------ | :---------------------------------------- | :--- |
...
| | 11:00 - 11:30 | - | *Intro Prática Tarde* | - |
| | **Tarde** | | | |
| | 13:00 - 13:50 | [FCST201](./fcst201) | **Aplicação**: O parâmetro Alpha ($\alpha$) | <Badge text="Prática" variant="tip" /> |
...
| :--- | :------ | :-------- | :--- |
| **03/06 (Qua)** | 08:00 - 11:30 | Projeto Integrado | Dados $\rightarrow$ Previsão de Demanda |
| | 13:00 - 16:00 | Projeto Integrado | Previsão $\rightarrow$ Planejamento de Estoque |
...
| Data | Horário | Atividade | Foco |
| :--- | :------ | :-------- | :--- |
| **22/06 (Seg)** | 08:00 - 11:30 | Projeto Integrado | Estoque $\rightarrow$ Distribuição (Rotas) |
