...
7. **Estruturar e consultar bancos de dados** para análise logística  
8. **Implementar análises práticas** usando Excel e Google Sheets
...
- **[EXL101 - Planilhas Eletrônicas para Negócios](./exl101)**: Domínio da ferramenta essencial (Excel e Google Sheets) para qualquer gestão.
